  ...
  return (
    <header className='sticky top-0 p-5 flex items-start justify-between max-w-7xl mx-auto z-20 xl:items-center'>
        <motion.div initial={{x: -500, opacity: 0, scale: 0.5}} animate={{x: 0, opacity: 1, scale: 1,}} transition={{duration: 1.5}} className='flex flex-row items-center'>
            {/* Social icons */}
            <SocialIcon url="https://linkedin.com/in/mahir-patel-b91b8424a/" fgColor='gray' bgColor='transparent'/>
            <SocialIcon url="https://github.com/MahirPatel3130" fgColor='gray' bgColor='transparent'/>
            <SocialIcon url="https://twitter.com/patelmahir042" fgColor='gray' bgColor='transparent'/>
        </motion.div>
          <a href="#contact">
